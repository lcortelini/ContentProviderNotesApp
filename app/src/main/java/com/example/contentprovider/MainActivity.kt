...
class MainActivity : AppCompatActivity(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = NotesAdapter(object : NoteCllickedListener {
        ...
        //GARANTIR QUE NÃO TENHAM IDS REPETIDAS DENTRO DO ADAPTER
        adapter.setHasStableIds(true)

        noteRecyclerView = findViewById(R.id.notes_recycler)
        //CRIA LAYOUT MANAGER E PASSA O ADAPTER PARA O RECYCLERVIEW
    ...
    //TERMINAR A PESQUISA EM SEGUNDO PLANO DO LOADMANAGER
